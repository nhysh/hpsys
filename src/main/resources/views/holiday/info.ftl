    ...
    <div class="layui-col-sm12 layui-col-md8 layui-col-lg9" style="width: 50%">
                <form class="layui-form" >
                    <div class="layui-form-item layui-row ">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input title"
                                   lay-verify="required" name="title" id="title" value="${(holidayApply.title)!}" readonly="readonly">
                        </div>
                    </div>
                    <div class="layui-form-item layui-row">
                    ...
                    <div class="layui-form-item layui-row">
                        ...
                        <div class="layui-input-block">
                            <textarea name="moreinfo" id="moreinfo" class="layui-textarea">${(holidayApply.remark)!}</textarea>
                        </div>
                    </div>
                </form>
    </div>
            ...
            <li class="layui-timeline-item">
                ...
                <#if hrCheck??>
                    ...
                    <#else>
                        ...
                        "></i>
                <div class="layui-timeline-content layui-text  ">
                    <h3 class="layui-timeline-title">行政:  <#list hrs as user>${user.empName}&ensp;</#list></h3>
                    <#if hrCheck??>
                        <p>
...
<script type="text/javascript" src="${ctx}/js/holiday/info.js"></script>
</body>
</html>